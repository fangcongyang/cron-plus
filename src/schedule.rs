...
use chrono::{DateTime, Datelike, Timelike, Utc, NaiveDate, Weekday};
        ...
        Z: TimeZone,
    {
            ...
            .cloned()
        {
            ...
            for month in self.fields.months.ordinals().range(month_range).cloned() {
                ...
                'day_loop: for day_of_month in ordinals.range(day_of_month_range).cloned()
                {
        ...
        Z: TimeZone,
    {
            ...
            .cloned()
        {
            ...
            for month in self.fields.months.ordinals().range(month_range).rev().cloned() {
                ...
                'day_loop: for day_of_month in ordinals.range(day_of_month_range).rev().cloned()
                {
...
fn get_nearest_weekday(date: NaiveDate) -> NaiveDate {
